	...
	<div class="panel-body" style="width: 100%; height: 95%">
		...
		<div class="row">
			<div class="col-lg-6 col-sm-6 col-xs-6">
				<ul class="list-group">
					<li class="list-group-item"><label>N° Ticket :</label> <%=session.getAttribute("TokenCIP")%></li>
					<li class="list-group-item"><label> Estado :</label>
					<s:label id="descripcionError" name="ESTADO" style="color:#009045;">DENEGADO</s:label>
					</li>
				</ul>
			</div>
			<div class="col-lg-6 col-sm-6 col-xs-6">
				<ul class="list-group">
					<li class="list-group-item"><label> Medio Pago : </label> <label
						style="color: #009045;">Openpay</label></li>
					<li class="list-group-item"><label> Descripción Error:</label>
						<s:label id="descripcionError" style="color:#E30613;"
							name="tarjetaCredito.descripcionError">Estimado <%=session.getAttribute("nombre")%>, no se pudo procesar su pago, <a href="window.history.back()">intentelo nuevamente</a></s:label></li>
				</ul>
			</div>
		</div>
	</div>
