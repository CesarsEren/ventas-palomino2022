...
<body class="nav-md">
									...
									<form method="post" class="form-horizontal" id="frmReclamos">
										<div class="row">
											<div class="col-md-3 col-sm-6 col-xs-12">
												...
												<s:select id="cboEmpresa" list="listaComboEmpresa"
													...
													cssClass="form-control input-sm empresa" listKey="Codigo"
													listValue="Razon" name="reclamos.Empresa" />

											</div>
											<div class="col-md-1 col-sm-3 col-xs-12">
												<label>Ruc</label> <input type="text" id="rucEmpresa"
													style="color: #009045; font-weight: bold;"
													class="form-control" readonly="readonly"
													value="<s:property  value='listaComboEmpresa[0].Ruc'/>">
											</div>
											<div class="col-md-4 col-sm-6 col-xs-12">
												<label>Direccion Legal</label> <input type="text"
													id="dirEmpresa" style="color: #009045; font-weight: bold;"
													class="form-control" readonly="readonly"
										...
										<div class="row">
											<div class="col-md-4 col-sm-6 col-xs-12">
												...
												<div class="input-group input-append date"
													...
													<input type="text"
														class="form-control input-sm fechaReclamo"
										...
										<div class="row">
											<div class="col-md-2 col-sm-6 col-xs-12">
												<label>Nombres:</label> <input type="text"
													class="form-control input-sm nombres"
													name="reclamos.Nombres" placeholder="Nombres"
											...
											<div class="col-md-1 col-sm-6 col-xs-12">
												<label>Telefono:</label> <input type="text"
													class="form-control input-sm telefono"
													name="reclamos.Telefono" placeholder="Teléfono"
										...
										<div class="row">
											<div class="col-md-4 col-sm-6 col-xs-12">
												<label>Domicilio:</label> <input type="text"
													class="form-control input-sm domicilio"
													name="reclamos.Domicilio" placeholder="Domicilio"
										...
										<div class="row">
											<div class="col-md-2 col-sm-6 col-xs-12">
												...
												<div
													class="input-group input-append date dateRangePickerIncidente">
													<input type="text"
														class="form-control input-sm fechaIncidente"
										...
										<div class="row">
											...
											<div class="col-md-2 col-sm-6 col-xs-12">
												<label>Numero</label> <input type="text"
													...
													onblur="javascript:VerificaDocumento(this);"
													required="required"><br>
											</div>
										</div>
										<div class="">
										...
										<div class="row">
											<div class="col-md-4">
												<label>Tipo</label> <select id="cboServicio"
													class="form-control input-sm" name="reclamos.TipoReclamo">
													<option value="R">Reclamo</option>
													<option value="Q">Queja</option>
												</select>
											</div>
											<!--<div class="col-md-6 col-sm-6 col-xs-12">
							<input id="reclamo" type="radio" name="reclamos.TipoReclamo" checked="checked" value="R"/>
								<label for="reclamo">Reclamo</label>
								<p>Disconformidad relacionada a los productos o servicios</p>
						</div>
						<div class="col-md-6 col-sm-6 col-xs-12">
							<input id="queja" type="radio" name="reclamos.TipoReclamo"  value="Q"/>
								<label for="queja">Queja</label>
								<p>Disconformidad no relacionada a los productos o servicios; o, malestar o descontento respecto a la atención del cliente al público.</p>
						</div>-->
										</div>
										<br>
										<div class="row">
											<div class="col-md-6 col-sm-6 col-xs-12">
												<label>Detalle</label>
												<textarea class="form-control input-sm detalle" rows="5"
													cols="5" name="reclamos.Detalle"
											...
											<div class="col-md-6 col-sm-6 col-xs-12">
												<label>Pedido</label>
												<textarea class="form-control input-sm pedido" rows="5"
													cols="5" name="reclamos.Pedido"
													placeholder="¿Qué espera obtener del reclamo ó queja?"
													required="required" style="text-transform: uppercase;"></textarea>
											</div>
											<br> <br>
											<div class="col-md-6 col-sm-6 col-xs-12">
												<label class="float-rigth" for="checksolucionado">¿El
													reclamo fue solucionado?</label> <input id="checksolucionado"
													name="reclamos.Atendido" type="checkbox" />
											</div>
										</div>
										<br> <br>
										<div id="seccionsolucion">
											<div class="">
												<div class="clearfix" style="border-color: #E9F513;">
													<div class="col-md-12 col-sm-12 col-xs-12"
														style="font-size: 15px; font-weight: bold; text-align: left; background-color: #FEEE00; color: #009045; background: linear-gradient(#FEEE00, #ccc97e), #D5DC93;">
														4.- SOLUCIÓN DEL RECLAMO</div>
												</div>

												<div class="row">
													<div class="col-md-6 col-sm-6 col-xs-12">
														<label>Detalle de Atención</label>
														<textarea class="form-control input-sm detalleatencion"
															rows="5" cols="5" name="reclamos.DetalleAtencion"
															placeholder="Detalle de la Atención descripcion en cortas palabras como fue solucionado."
															required="required" style="text-transform: uppercase;"></textarea>
													</div>
												</div>
											</div>
								...
								<div class="row">
									...
									<div class="modal fade" id="modalReclamoConfirmado"
										tabindex="-1" role="dialog" aria-labelledby="modalR">
											...
											<div class="modal-content">
												<div class="modal-header"
													...
													<h4 class="modal-title" id="modalLabelPaso2">Su
														reclamo ha sido enviado satisfactoriamente</h4>
												</div>
												<div class="modal-body"
													style="max-height: calc(100vh - 210px); overflow-y: auto;">
													<div class="row" style="padding-left: 5px;">
														<form method="post" id="frmAtencionReclamo"
															action="imprimiratencionreclamos" autocomplete="off"
															accept-charset="UTF-8">
															<input type="hidden" id="hidPeriodo"
																name="reclamos.Periodo"> <input type="hidden"
																id="hidNroR" name="reclamos.Nro"> <input
															...
															<div class="col-md-12 col-sm-12 col-xs-12">
																...
																<div class="row">
																	...
																	<div class="form-group col-xs-8">
																		<s:label name="reclamos.ServicioD"
																			id="hidMotivoReclamoD"></s:label>
																	</div>
																</div>
																<div class="row">
																	<div class="form-group col-xs-4">
													...
													<div class="row">
														<div class="col-xs-12">
															<div class="row">
																...
																<div class="form-group col-xs-8">
																	<div class="input-group">
																		...
																		<input type="text" id="txtReenvioCorreo"
																			class="form-control" placeholder="Enviar Correo">
																	</div>
																</div>
																<div class="form-group col-xs-1">
															...
															<div class="row">
																...
																<div class="col-xs-5">
																	<button id="btnImprimirAtencionReclamo" type="button"
	...
	<script
		src="${pageContext.request.contextPath}/_lib/atencionreclamos/atencionreclamos.js"
		charset="UTF-8"></script>
	<script>
		$(document).ready(function() {
			$("#seccionsolucion").css("display","none");
			$('#checksolucionado').on("change",function(){
			if ($('#checksolucionado').prop('checked')) {
				$("#seccionsolucion").css("display","block"); 
				}else{
					$("#seccionsolucion").css("display","none");
				}			
			})
