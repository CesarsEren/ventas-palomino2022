						...
						<div class="col-md-12 col-sm-12 col-xs-12">
							<div class="x_panel">
								<div class="x_content">
									...
									<hr />
									<h4>Usuarios para Transporte de Personal</h4>
									<hr />
												...
												<table class="table table-hover" data-toggle="table">
													<thead>
														<tr>
															...
															<th class="th-inner">Usuario</th>
															<th class="th-inner">DNI</th>
															<th class="th-inner">Tipo Usuario</th>
															<th class="th-inner">Estado</th>
														</tr>
													</thead>
													<tbody>
													</tbody>
