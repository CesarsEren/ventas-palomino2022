					...
					<div class="row">
						...
						<div class="col-md-12 col-sm-12 col-xs-12">
							<div class="x_panel">
								<div class="x_content">
									<fieldset>
										<legend>REGISTRAR CLIENTE Y RUTAS</legend>
										<form action="nuevoclienteruta" method="post"
											autocomplete="off" accept-charset="UTF-8">
											<jsp:include page="_form.jsp"></jsp:include>
											<input type="submit" class="btn btn-success"
												value="REGISTRAR" id="btnRegistraClienteRutas"> <a
												href="accedelistaclienteruta" class="btn btn-primary">LISTAR
												CLIENTES RUTAS</a>
										</form>
									</fieldset>
								</div>
