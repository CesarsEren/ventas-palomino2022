						...
						<div class="col-md-12 col-sm-12 col-xs-12">
							<div class="x_panel">
								<div class="x_content">
									...
									<hr />
									<div class="row">
										<form id="frmVersion" action="eliminaversiones" method="post">
											<table id="tablaVersion" data-toggle="table"
												data-locale="es-ES" data-url="listaversiones"
												data-side-pagination="server" data-pagination="true"
												data-response-handler="responseHandler">
												<thead>
													<tr>
														<th data-field="plataforma">Plataforma</th>
														<th data-field="fecha">Fecha</th>
														<th data-field="version">Version</th>
														<th data-field="critico">Critico</th>
														<th data-field="id" data-formatter="operacionesVersiones">OPERACIONES</th>
													</tr>
												</thead>
											</table>
											<input type="hidden" id="valor" name="version.id">
										</form>
									</div>
									<hr />
									<div class="row">
										<a href="nuevoversionapp" class="btn btn-primary">NUEVA
											VERSION APP</a>
									</div>
								</div>
							</div>
