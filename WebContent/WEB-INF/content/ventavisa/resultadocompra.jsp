		...
		<div class="col-xs-8 col-xs-offset-2">
			<table class="table table-condensed">
				<tbody>
					...
					<tr>
						<td>ID. del Pedido :</td>
						<td><s:property value="%{respuestaVisa.pedidoID}" /></td>
					</tr>
					<tr>
						<td>Numero de Tarjeta :</td>
						<td><s:property value="%{respuestaVisa.pan}" /></td>
					</tr>
					<tr>
						<td>Fecha y Hora :</td>
						<td><s:property value="%{respuestaVisa.dsc_cod_accion}" /></td>
					</tr>
					<tr>
						<td>Importe :</td>
						<td><s:property value="%{respuestaVisa.dato_comercio}" /></td>
					</tr>
					<tr>
						<td>Moneda :</td>
						<td>SOL</td>
					...
					<tr>
						...
						<td><s:property value="%{respuestaVisa.nombre_th}" /></td>
					</tr>
					<tr>
						<td>Codigo Accion :</td>
						<td>Confirmado</td>
