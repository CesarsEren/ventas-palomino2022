...
function operacionesUsuario(id, estado){
	var html = [];
	
	var estado = estado['estado'];
	
	var btnVerUsuario = "<a href='verusuario?id="+id+"' class='btn btn-sm btn-default'>VER</a>&nbsp;";
	var btnModificar  = "<a href='actualizausuario?id="+id+"' class='btn btn-sm btn-info'>MODIFICAR</a>&nbsp;";
	var btnEstado;
...
/*
$('.hrefCuenta').on('click',function(){
	
	$("#idpanelAcceso").addClass('animated ' + 'bounceOutLeft');
	$("#idpanelAcceso").hide();
	$("#idpanelRegistro").show().addClass('animated ' + 'bounceInLeft');
});
