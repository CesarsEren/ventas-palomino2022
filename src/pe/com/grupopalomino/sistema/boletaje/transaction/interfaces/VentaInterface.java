...
public interface VentaInterface {
	...
	public B_VentaBean DatosDinamicosVenta(B_VentaBean venta,B_Correlativos correlativo,String FechaEmision,VentaPaso2Form paso2Form,VentaPaso3Form paso3Form,List<V_CroquisBusBean> listaCroquisBus,int minValor,SpringSecurityUser usuario,List<B_PrecioProgramacion> b_PrecioProgramacions)throws Exception;
	...
	public B_VentaBean DatosDinamicosVentaVuelta(B_VentaBean venta,B_Correlativos correlativo,String FechaEmision,VentaPaso2Form paso2Form,VentaPaso4Form paso4Form,List<V_CroquisBusBean> listaCroquisBus,int minValor,SpringSecurityUser usuario,List<B_PrecioProgramacion> b_PrecioProgramacions)throws Exception;
